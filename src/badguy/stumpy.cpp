...
Stumpy::Stumpy(const ReaderMapping& reader) :
  WalkingBadguy(reader, "images/creatures/forestbadguys/mr_tree/stumpy.sprite","left","right", LAYER_OBJECTS,
...
Stumpy::Stumpy(const Vector& pos, Direction d) :
  WalkingBadguy(pos, d, "images/creatures/forestbadguys/mr_tree/stumpy.sprite","left","right"),
