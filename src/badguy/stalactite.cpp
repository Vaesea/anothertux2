...
Stalactite::Stalactite(const ReaderMapping& mapping) :
  StickyBadguy(mapping, "images/creatures/miscbadguys/stalactite/ice/icicle.sprite", LAYER_TILES - 1, COLGROUP_MOVING),
  timer(),
...
Stalactite::get_default_sprite_name() const
{
  ...
  {
    case WOOD:
      return "images/creatures/miscbadguys/stalactite/wood/forest1.sprite";
    default:
